...
// The nestedFunction can access the variable internal since they are both located within the same function scope.
...
const zooAnimals = [
  ...
  */
  ...
  function animalNames(array) {
    let displayNames = [];
    array.forEach((value) => {
      let string = `name: ${value.animal_name}, scientific: ${value.scientific_name}`
  ...
  */
  ...
  function lowerCaseNames(array) {
    let names = array.map((elem) => elem.animal_name.toLowerCase()); {
      return names;
    }  
  }  
  ...
  */
  ...
  function lowPopulationAnimals(array) {
    const lowPop = array.filter(elem => elem.population < 5);
    return lowPop;
  }
  ...
  */
  ...
  function USApop(array) {
    const totalPop = array.reduce((total, elem) => {
...
let cuboidTwo = new CuboidMakerTwo({length: 10, width: 20, height: 30})
